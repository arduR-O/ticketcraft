...
class CatalogRepositoryTests {
    ...
    void testDatabaseMappingsAndQueries() {
        ...
        Artist artist = Artist.builder().name("Queen")
                .genre("Rock")
                .description(
        ...
        Venue venue = Venue.builder()
                ...
                .location("London, UK").capacity(90000)
                .latitude(51.5560).longitude(-0.2796)
                .build();
        Venue savedVenue = venueRepository.save(venue);
        assertThat(savedVenue.getId()).isNotNull();
        assertThat(savedVenue.getLatitude())
                .isEqualTo(51.5560);
        assertThat(savedVenue.getLongitude())
                .isEqualTo(-0.2796);
        ...
        Event event = Event.builder()
                ...
                .artist(savedArtist).venue(savedVenue)
                .build();
        Event savedEvent = eventRepository.save(event);
        assertThat(savedEvent.getId()).isNotNull();

        // 4. Create and Save Seats
        Seat seat1 = Seat.builder().seatNumber("A-101")
                .rowNumber("Row-10").section("Section 101")
                .xCoordinate(10).yCoordinate(20)
                .category(SeatCategory.VIP)
                .status(SeatStatus.AVAILABLE)
                .price(new BigDecimal("150.00"))
                .event(savedEvent).build();

        Seat seat2 = Seat.builder().seatNumber("A-102")
                .rowNumber("Row-10").section("Section 101")
                .xCoordinate(30).yCoordinate(20)
        ...
        List<Seat> seats = seatRepository
                .findByEventId(savedEvent.getId());
        assertThat(seats).hasSize(2);
        assertThat(seats).extracting(Seat::getSeatNumber)
                .containsExactlyInAnyOrder("A-101",
                        "A-102");
        assertThat(seats).extracting(Seat::getSection)
                .containsOnly("Section 101");
        assertThat(seats).extracting(Seat::getXCoordinate)
                .containsExactlyInAnyOrder(10, 30);
        assertThat(seats).extracting(Seat::getYCoordinate)
                .containsOnly(20);
    }
}
